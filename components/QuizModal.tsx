...
const QuizModal: React.FC<QuizModalProps> = ({ verse, onClose, apiKey }) => {
    ...
    const renderContent = () => {
        ...
        if (!quizData || !textParts) {
            return <div className="text-center text-slate-400 p-8">퀴즈를 불러올 수 없습니다.</div>;
        }
    ...
    return (
        <div className="fixed inset-0 bg-black bg-opacity-70 flex items-center justify-center z-50 p-4" role="dialog" aria-modal="true">
            <div className="bg-slate-800 rounded-xl shadow-xl w-full max-w-2xl transform transition-all overflow-hidden flex flex-col">
